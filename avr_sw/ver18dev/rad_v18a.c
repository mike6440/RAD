...
// v18 ::
//		* add menu for S to give input voltages
// 		170303--this code was sent o Ray Edwards.
// v18a :: I fixed  two compile errors from Ray email
/*********************************************
...
int state;
unsigned char version[10] = "1.18";  //v15  v16 v17 v17a v17b v18
unsigned char verdate[20] = "2017,03,03";  //v15 v16 v17 v17a v17b v18
float Tabs = 273.15;
int adc[NCHANS];   
	...
	switch (ch) 
	{
        ...
        case '/':
           ...
           // printf("'Z' for eeprom setup\r\n");
            ...
            printf("'E' -->Sample 12 bit A to D -- compute Vin\r\n");
...
**************************************************/
{
	...
	// xxxx v18 We want a small delay for the multiplexer to settle.
	delay(8); //v18 8 millisecs seems is used for ads1115.
...
/********************************************************
Test the ADC circuit
compute the input voltages for the different channels
psp chan 0
pir chan 1
Case chan 2
**********************************************************/
