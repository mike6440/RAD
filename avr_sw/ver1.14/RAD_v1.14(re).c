...
int state;
unsigned char version[10] = "1.14";
unsigned char verdate[20] = "2007/11/26"; 
double Tabs = 273.15;
int adc[NCHANS];   
...
{ 
	...
	printf("\n\r");
	printf("\n\r NOAA RADIOMETER INTERFACE BOARD (REV B) VERSION: %s, VERSION DATE: %s\n\r", version, verdate);
